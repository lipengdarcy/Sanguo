...
public class ExchangesUserType extends BlobUserType {
	public Object deepCopy(Object obj) throws HibernateException {
		return ((obj == null) ? null : (Exchanges) obj);
	}
	...
	public Object nullSafeGet(ResultSet resultSet, String[] names, SessionImplementor session, Object owner)
		...
		if (bytes != null) {
			exchanges = (Exchanges) SerialUtil.deSerialize(bytes);
		}
		if (exchanges == null) {
	...
	public void nullSafeSet(PreparedStatement statement, Object obj, int index, SessionImplementor session)
			throws HibernateException, SQLException {
		byte[] bytes = SerialUtil.serialize((Exchanges) obj);
		if (bytes != null)
