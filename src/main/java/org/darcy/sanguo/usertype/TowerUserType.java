...
public class TowerUserType extends BlobUserType {
	...
	public Object nullSafeGet(ResultSet resultSet, String[] names, SessionImplementor session, Object owner)
		...
		TowerRecord r = null;
		if (bytes != null) {
			r = (TowerRecord) SerialUtil.deSerialize(bytes);
		}
	...
	public void nullSafeSet(PreparedStatement statement, Object obj, int index,SessionImplementor session)
			throws HibernateException, SQLException {
		byte[] bytes = SerialUtil.serialize((TowerRecord) obj);
		if (bytes != null)
