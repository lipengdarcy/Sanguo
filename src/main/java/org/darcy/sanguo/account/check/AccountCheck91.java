...
public class AccountCheck91 extends AbstractAccountCheckAsyncCall {
	public static final String APP_ID = "6541812";
	public static final String SECRET_KEY = "r6Ndr2jdcHBR0LKeSEQg7t5Tgt6Gs3fz";
	private String accessToken;

	public AccountCheck91(ClientSession session, PbPacket.Packet packet) throws InvalidProtocolBufferException {
	...
	public String getPostData() {
		String sign = md5("6541812" + this.accessToken + "r6Ndr2jdcHBR0LKeSEQg7t5Tgt6Gs3fz");
		StringBuilder param = new StringBuilder();
		param.append("AppID=").append("6541812");
	...
	public void unPack(JSONObject json) {
		try {
			if ((Integer.parseInt(json.getString("ResultCode")) == 1) && (md5("6541812" + json.getString("ResultCode")
					+ URLDecoder.decode(json.getString("Content"), "utf-8") + "r6Ndr2jdcHBR0LKeSEQg7t5Tgt6Gs3fz")
