...
import org.darcy.sanguo.task.Task;
 ...
 public class WorldCompetitionGetScoreFC extends AbstractFCondition
 {
   int gole;
 
   public WorldCompetitionGetScoreFC(int paramCount)
   {
     super(paramCount);
   }
   ...
   {
     WorldCompetitionGetScoreFC fc = new WorldCompetitionGetScoreFC(this.paramCount);
     super.copy(fc);
     return fc;
   }
