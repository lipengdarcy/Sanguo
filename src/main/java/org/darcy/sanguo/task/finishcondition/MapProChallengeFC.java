...
import org.darcy.sanguo.task.Task;
 ...
 public class MapProChallengeFC extends AbstractFCondition
 {
   int gole;
 
   public MapProChallengeFC(int paramCount)
   {
     super(paramCount);
   }
   ...
   {
     MapProChallengeFC fc = new MapProChallengeFC(this.paramCount);
     super.copy(fc);
     return fc;
   }
