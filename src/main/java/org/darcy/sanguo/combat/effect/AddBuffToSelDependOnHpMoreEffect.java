...
import org.darcy.sanguo.unit.Unit;
 ...
 public class AddBuffToSelDependOnHpMoreEffect extends Effect
 {
   private int buffId;
   private int rate;
   private int refer;
 
   public AddBuffToSelDependOnHpMoreEffect(int id, int type, String description, int paramCount, int catagory)
   {
   ...
   public Effect copy()
   {
     AddBuffToSelDependOnHpMoreEffect e = new AddBuffToSelDependOnHpMoreEffect(this.id, this.type, this.description, this.paramCount, this.catagory);
