...
import org.darcy.sanguo.unit.Unit;
 ...
 public class AddBuffToEnemysEffect extends Effect
 {
   private int buffId;
 
   public AddBuffToEnemysEffect(int id, int type, String description, int paramCount, int catagory)
   {
   ...
   public Effect copy()
   {
     AddBuffToEnemysEffect e = new AddBuffToEnemysEffect(this.id, this.type, this.description, this.paramCount, this.catagory);
