...
import org.darcy.sanguo.unit.Unit;
 ...
 public class AnshaEffect extends Effect
 {
   private int value;
   private int rate;
 
   public AnshaEffect(int id, int type, String description, int paramCount, int catagory)
   {
   ...
   public Effect copy()
   {
     AnshaEffect e = new AnshaEffect(this.id, this.type, this.description, this.paramCount, this.catagory);
