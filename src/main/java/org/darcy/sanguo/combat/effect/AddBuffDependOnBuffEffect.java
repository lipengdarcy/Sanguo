...
import org.darcy.sanguo.unit.Unit;
 ...
 public class AddBuffDependOnBuffEffect extends Effect
 {
   ...
   public AddBuffDependOnBuffEffect(int id, int type, String description, int paramCount, int catagory)
   {
   ...
   public Effect copy()
   {
     AddBuffDependOnBuffEffect e = new AddBuffDependOnBuffEffect(this.id, this.type, this.description, this.paramCount, this.catagory);
