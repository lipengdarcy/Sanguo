...
import org.darcy.sanguo.unit.Unit;
 ...
 public class AddBuffToSelDependOnHpLessEffect extends Effect
 {
   private int buffId;
   private int rate;
   private int refer;
 
   public AddBuffToSelDependOnHpLessEffect(int id, int type, String description, int paramCount, int catagory)
   {
   ...
   public Effect copy()
   {
     AddBuffToSelDependOnHpLessEffect e = new AddBuffToSelDependOnHpLessEffect(this.id, this.type, this.description, this.paramCount, this.catagory);
   ...
   {
     if (owner.getAttributes().getHp() * 10000L <= this.refer * owner.getAttributes().get(7)) {
