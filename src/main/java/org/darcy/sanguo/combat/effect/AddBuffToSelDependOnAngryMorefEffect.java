...
import org.darcy.sanguo.unit.Unit;
 ...
 public class AddBuffToSelDependOnAngryMorefEffect extends Effect
 {
   private int buffId;
   private int rate;
   private int refer;
 
   public AddBuffToSelDependOnAngryMorefEffect(int id, int type, String description, int paramCount, int catagory)
   {
   ...
   public Effect copy()
   {
     AddBuffToSelDependOnAngryMorefEffect e = new AddBuffToSelDependOnAngryMorefEffect(this.id, this.type, this.description, this.paramCount, this.catagory);
