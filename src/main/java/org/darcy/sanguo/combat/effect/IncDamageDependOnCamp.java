...
import org.darcy.sanguo.unit.Unit;
 ...
 public class IncDamageDependOnCamp extends Effect
 {
   private int refer;
   private int value;
   private int rate;
 
   public IncDamageDependOnCamp(int id, int type, String description, int paramCount, int catagory)
   {
   ...
   public Effect copy()
   {
     IncDamageDependOnCamp e = new IncDamageDependOnCamp(this.id, this.type, this.description, this.paramCount, this.catagory);
   ...
   {
     if (combatContent.getTarget().getCamp() == this.refer) {
