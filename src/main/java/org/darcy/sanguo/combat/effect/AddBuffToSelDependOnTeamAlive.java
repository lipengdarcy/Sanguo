...
import org.darcy.sanguo.unit.Unit;
 ...
 public class AddBuffToSelDependOnTeamAlive extends Effect
 {
   private int buffId;
   private int camp;
 
   public AddBuffToSelDependOnTeamAlive(int id, int type, String description, int paramCount, int catagory)
   {
   ...
   public Effect copy()
   {
     AddBuffToSelDependOnTeamAlive e = new AddBuffToSelDependOnTeamAlive(this.id, this.type, this.description, this.paramCount, this.catagory);
   ...
   public void initParams()
   {
     ...
     this.camp = Integer.parseInt(this.params[1]);
   }
   ...
   public int[] effectBuff(Unit owner, Unit caster, Section section)
   {
     ...
     for (Unit u : team.getUnits()) {
       if ((u != null) && (u.isAlive()) && (u.getCamp() == this.camp)) {
         ++count;
       }
     }
