...
import org.darcy.sanguo.unit.Unit;
 ...
 public class IncDamageDependOnActorCamp extends Effect
 {
   private int refer;
   private int value;
   private int rate;
 
   public IncDamageDependOnActorCamp(int id, int type, String description, int paramCount, int catagory)
   {
   ...
   public Effect copy()
   {
     IncDamageDependOnActorCamp e = new IncDamageDependOnActorCamp(this.id, this.type, this.description, this.paramCount, this.catagory);
   ...
   {
     if (combatContent.getSrc().getCamp() == this.refer) {
