...
import org.darcy.sanguo.unit.Unit;
 ...
 public class IncDamageDependOnTargetHpLessEffect extends Effect
 {
   private int refer;
   private int value;
   private int rate;
 
   public IncDamageDependOnTargetHpLessEffect(int id, int type, String description, int paramCount, int catagory)
   {
   ...
   public Effect copy()
   {
     IncDamageDependOnTargetHpLessEffect e = new IncDamageDependOnTargetHpLessEffect(this.id, this.type, this.description, this.paramCount, this.catagory);
