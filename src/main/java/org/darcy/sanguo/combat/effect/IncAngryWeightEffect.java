...
import org.darcy.sanguo.util.Calc;
 ...
 public class IncAngryWeightEffect extends Effect
 {
   private int[] weights = new int[6];
 
   public IncAngryWeightEffect(int id, int type, String description, int paramCount, int catagory) {
     super(id, type, description, paramCount, catagory);
   }
 
   public Effect copy()
   {
     IncAngryWeightEffect e = new IncAngryWeightEffect(this.id, this.type, this.description, this.paramCount, this.catagory);
