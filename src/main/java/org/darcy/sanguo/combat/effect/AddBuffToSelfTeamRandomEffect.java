...
import org.darcy.sanguo.unit.Unit;
 ...
 public class AddBuffToSelfTeamRandomEffect extends Effect
 {
   private int buffId;
 
   public AddBuffToSelfTeamRandomEffect(int id, int type, String description, int paramCount, int catagory)
   {
   ...
   public Effect copy()
   {
     AddBuffToSelfTeamRandomEffect e = new AddBuffToSelfTeamRandomEffect(this.id, this.type, this.description, this.paramCount, this.catagory);
