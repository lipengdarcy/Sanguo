...
import org.darcy.sanguo.unit.Unit;
 ...
 public class IncDamageDependOnActorGender extends Effect
 {
   private int refer;
   private int value;
   private int rate;
 
   public IncDamageDependOnActorGender(int id, int type, String description, int paramCount, int catagory)
   {
   ...
   public Effect copy()
   {
     IncDamageDependOnActorGender e = new IncDamageDependOnActorGender(this.id, this.type, this.description, this.paramCount, this.catagory);
   ...
   {
     if (combatContent.getSrc().getGender() == this.refer) {
