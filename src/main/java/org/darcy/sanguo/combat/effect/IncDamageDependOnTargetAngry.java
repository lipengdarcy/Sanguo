...
import org.darcy.sanguo.unit.Unit;
 ...
 public class IncDamageDependOnTargetAngry extends Effect
 {
   private int refer;
   private int value;
   private int rate;
 
   public IncDamageDependOnTargetAngry(int id, int type, String description, int paramCount, int catagory)
   {
   ...
   public Effect copy()
   {
     IncDamageDependOnTargetAngry e = new IncDamageDependOnTargetAngry(this.id, this.type, this.description, this.paramCount, this.catagory);
